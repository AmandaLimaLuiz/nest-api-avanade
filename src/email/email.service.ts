...
export class EmailService {
  async sendEmail(to: string, subject: string, msg: string, options: object) {
    ...
    const transporter = nodemailer.createTransport({
        ...
        auth:{
            type: 'OAuth2',
            user:  'delimaluiz.amanda@gmail.com',
            clientID: clientID,
    ...
    const mailOptions = {
        from: 'delimaluiz.amanda@gmail.com',
        to: to,
        bcc: 'delimaluiz.amanda@gmail.com',
        subject: subject,
        html: `
            Enviando email com node + gmail + NestJS + OAuth2 
            <h1>${msg}</h1> Somente especialistas.
        `,
    };
